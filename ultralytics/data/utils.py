...
def check_det_dataset(dataset, autodownload=True):
    ...
    if "test" in data and "test_ir" not in data:
        raise SyntaxError(
            emojis(f"{dataset} 'test_ir:' key missing ❌.\nWhen using 'test:' in a two-stream dataset, 'test_ir:' is also required.")
        )
    ...
    for k in "train", "val","train_ir","val_ir", "test", "test_ir", "minival":
